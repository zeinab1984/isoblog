        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="/dashbord/categories/index.php" class="nav-link"> لیست دسته بندی</a>
                    </li>
                    <li class="nav-item">
                        <a href="/dashbord/categories/creat.php" class="nav-link"> ایجاد دسته بندی جدید</a>
                    </li>
                    <li class="nav-item">
                        <a href="/dashbord/post/index.php" class="nav-link"> لیست پست ها</a>
                    </li>
                    <li class="nav-item">
                        <a href="/dashbord/post/creat.php" class="nav-link"> ایجاد پست جدید</a>
                    </li>
                    <li class="nav-item">
                        <a href="/dashbord/comment/index.php" class="nav-link"> لیست کامنت ها</a>
                    </li>
                </ul>
            </nav>
            <!-- /.sidebar-menu -->
